...
<script type="text/javascript" src="{{asset('assets/forms.js')}}"></script>
<script type="text/javascript" src="{{asset('assets/global/plugins/SortableJS.js')}}"></script>
...
{{--if you are concatincating the scripts use toastr from asset('assets/global/plugins/bootstrap-toastr/toastr.js') --}}
...
<script src="{{asset('assets/uploader.js')}}" type="text/javascript"></script>
